...
")))
 ...
 '(newsticker-url-list
   '(("Fringe Elements" "https://odysee.com/$/rss/@TheAltHype:6" nil nil nil)
     ...
     ("Protesilaos Stavrou" "https://odysee.com/$/rss/@protesilaos:6" nil nil nil)
     ...
     ("Right History" "https://www.youtube.com/feeds/videos.xml?channel_id=UC5Lg1FOtCMr3okN-iuM9jNQ" nil nil nil)
 ...
 '(php-mode-hook '(skempo-mode subword-mode))
 '(proced-tree-flag t)
 ...
 '(sgml-basic-offset 4)
 '(sh-mode-hook
   '(sh-electric-here-document-mode flymake-shellcheck-load flymake-mode))
